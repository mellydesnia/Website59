...
<head>
    ...
    <title>Hub Admin - SMP NEGERI 59 KOTA BANDUNG</title>
...
<body>
    <div class="wrapper">
        <div class="title">Hubungi Bot Admin</div>
        <div class="form">
   ...
   <a class="btn btn-primary" href="index.php" role="button">Kemabli ke halaman utama</a>
