...
<div class="container">
    ...
    <div class="row" id="load_data">
      <?php
        include 'koneksi.php';
        $query = "SELECT * FROM t_fasilitas ORDER BY id ASC";
        ...
        while ($row = $res1->fetch_assoc()) {
          ...
          if (strlen($keterangan) > 60) {
            $keterangan = substr($keterangan, 0, 60) . "...";
          }
      ?>
...
<div class="responsive">
  <div class="gallery">
    <img src="gambar/<?= $row['foto'] ?>" alt="gambar" width="600" height="400">
    </a>
    <div class="desc"><?php echo $keterangan; ?></div>
  </div>
</div>
