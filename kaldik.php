...
<head>
    <meta charset="utf-8">
    <title>KALDIK - SMP NEGERI 59 KOTA BANDUNG</title>
...
<div class="container">
    <h2 align="center">Kalender Pendidikan</h2>
    <hr>
    <br>
    <div class="row" id="load_data">
      <?php
        include 'koneksi.php';
        $query = "SELECT * FROM tbl_kaldik ORDER BY id ASC";
      ...
      ?>
                ...
                <img src="images/kegiatan/<?= $row['foto'] ?>" alt="gambar" width="60%" height="60%" style="display: block; margin: auto;" >
