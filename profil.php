...
<head>
    <meta charset="utf-8">
    <title>Profile OSIS - SMP NEGERI 59 KOTA BANDUNG</title>
...
<div class="container">
    <h2 align="center">Profile OSIS</h2>
    
    <br><br><br><br>
    <center><h2>Struktur Organisasi OSIS</h2></center>
    <hr>
    <br>
    <div class="row" id="load_data">
      <?php
        include 'koneksi.php';
        $query = "SELECT * FROM tbl_profilosis ORDER BY id ASC";
      ...
      ?>
                ...
                <img src="images\profileosis/<?= $row['foto'] ?>" alt="gambar" width="60%" height="60%" style="display: block; margin: auto;" >
